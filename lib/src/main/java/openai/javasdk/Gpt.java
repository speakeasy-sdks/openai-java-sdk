...
public class Gpt {
	...
	public static class Builder {
		...
		public Builder setServerURL(String serverUrl, java.util.Map<String, String> params) {
			this.sdkConfiguration.serverUrl = openai.javasdk.utils.Utils.templateUrl(serverUrl, params);
			return this;
		}
		...
		public Gpt build() throws Exception {
			...
			return new Gpt(this.sdkConfiguration);
		}
	}
	...
	private Gpt(SDKConfiguration sdkConfiguration) throws Exception {
