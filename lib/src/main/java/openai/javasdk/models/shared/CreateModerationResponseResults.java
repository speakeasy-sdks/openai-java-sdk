...
public class CreateModerationResponseResults {
    @JsonProperty("categories")public CreateModerationResponseResultsCategories categories;
    public CreateModerationResponseResults withCategories(CreateModerationResponseResultsCategories categories) {
        this.categories = categories;
        return this;
    }
    
    @JsonProperty("category_scores")public CreateModerationResponseResultsCategoryScores categoryScores;
