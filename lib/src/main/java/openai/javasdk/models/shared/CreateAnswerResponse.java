...
public class CreateAnswerResponse {
    ...
    @JsonProperty("answers")public String[] answers;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("completion")public String completion;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("selected_documents")public CreateAnswerResponseSelectedDocuments[] selectedDocuments;
